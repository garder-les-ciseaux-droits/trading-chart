<template>
  <main>
    <section class="w-screen h-screen flex justify-center items-center bg-[url('https://raw.githubusercontent.com/garder-les-ciseaux-droits/echidna/main/uploads/background.jpg')] bg-cover bg-center min-w-0 max-w-[1440px] max-h-[900]">
      <div class="relative w-[1440px] overflow-hidden h-full flex flex-col items-center justify-center bg-[url('https://raw.githubusercontent.com/garder-les-ciseaux-droits/echidna/main/uploads/background.jpg')] bg-cover bg-center min-w-0">
